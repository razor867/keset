...
<script src="<?= base_url('js/pages/listdata_departments.js') ?>"></script>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <div class="row">
            <div class="col-md-4">
                <h6 class="m-0 font-weight-bold text-primary">Departments data in office</h6>
            </div>
            <div class="col-md-8 mt-3">
                <a class="btn btn-sm btn-primary float-right" href="<?= base_url('utilities/form_departments') ?>"><i class="fas fa-fw fa-plus"></i> Add</a>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th class="wrap-max-80">Nama Departemen</th>
