...
<input type="hidden" name="consumables_id" value="<?= $id ?>">
...
<div class="form-group row">
    <label for="qty" class="col-sm-3 col-form-label">Jumlah Aset</label>
    <div class="col-sm-4">
        <input type="number" class="form-control <?= ($validation->hasError('qty') ? 'is-invalid' : '') ?>" id="qty" name="qty" min="0" value="<?= ($is_edit) ? $qty : old('qty') ?>">
        <div class="invalid-feedback">
