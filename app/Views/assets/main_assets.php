...
<script src="<?= base_url('js/pages/listdata_main_assets.js') ?>"></script>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <div class="row">
            <div class="col-md-4">
                <h6 class="m-0 font-weight-bold text-primary">Main Assets Data</h6>
            </div>
            <div class="col-md-8 mt-3">
                <a class="btn btn-sm btn-primary float-right" href="<?= base_url('assets/form_main_assets') ?>"><i class="fas fa-fw fa-plus"></i> Add</a>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th class="wrap-max-30">Nama Aset</th>
                        <th class="wrap-max-10">Tipe</th>
                        <th class="wrap-max-20">Detail</th>
                        <th class="wrap-max-10">Total</th>
                        <th class="wrap-max-20">Harga</th>
